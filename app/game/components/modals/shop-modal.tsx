      ...
      <div className="relative z-10 flex max-h-full w-full max-w-[60rem] flex-col items-stretch gap-3 sm:flex-row sm:items-start">
        ...
        >
          ...
          <nav
            ...
            className="shop-category-nav overflow-x-auto overflow-y-hidden border-y border-[var(--border-soft)] px-4 py-3 sm:px-7"
          >
            <div
              className="grid gap-2"
              style={{
                gridTemplateColumns: `repeat(${categorySlots.length}, minmax(6.25rem, 1fr))`,
                minWidth: `${categorySlots.length * 7}rem`,
              }}
            >
          ...
          <div className="shop-items-scroll min-h-0 flex-1 overflow-y-auto p-4 sm:overflow-y-scroll sm:p-5">
            {!isSignedIn && (
