  ...
  return (
    <main className="theme-page-bg min-h-dvh flex items-center justify-center px-4 py-6">
      <div className="w-full max-w-[42rem] flex flex-col gap-6">
        ...
        {/* Content */}
        <section className="theme-card rounded-2xl p-6 text-center flex flex-col gap-6">
          ...
          <div>
            ...
            <h1 className="theme-text-primary font-fredoka-display mt-2 text-[2.2rem] sm:text-[2.8rem] leading-none tracking-[-0.04em]">
              ColorTile
            </h1>
          ...
          <div className="flex flex-col gap-4 text-left text-sm sm:text-base">
            ...
            <p className="theme-text-secondary">
              ⚡ <span className="font-semibold">Progression</span><br />
            ...
            <p className="theme-text-secondary">
              🧠 <span className="font-semibold">Skill-Based</span><br />
